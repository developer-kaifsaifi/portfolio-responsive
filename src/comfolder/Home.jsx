...
export default function Home() {
  return (<>
  <div className="flex  overflow-x-hidden  h-screen bg-[url('./assets/download.avif')]  bg-center bg-cover"></div>
    <div className="flex w-screen z-500 absolute top-0  items-center justify-center h-screen  from-black via-gray-900 to-black">
      <div className="w-screen h-screen   bg-[#000000e7] ">
        {" "}
        <div className="w-35  rounded-full fixed top-56 blue-shadow right-30  rotate-130" />
        <div className="w-35  rounded-full fixed -bottom-10 pink-shadow left-30  rotate-130" />
               
        <div className="w-full px-50 text-center relative top-24 h-60  text-[60px] outfit text-white flex flex-col  items-center justify-center font-semibold  ">
          {" "}
          <h1 >Hey there! I'm Mohammad Kaif 👋</h1>
          <h1 className="-mt-8 ">
            a Full-Stack Web{" "}
            <span className="nyght italic text-[76px] moving-bg-text "> Developer</span>
          </h1>
        </div>
        <div className="w-full px-50 text-center relative h-40 top-6 text-[72px] outfit text-[#9C9C9C] flex flex-col   items-center justify-center font-semibold  ">
          {" "}
        ...
        <div className="w-full  text-center relative h-10 top-8 gap-4 text-[13px] outfit text-[#9C9C9C] flex   items-center justify-center   ">
...
<svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="18" width="18" xmlns="http://www.w3.org/2000/svg"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg> Scalable</span>
        ...
        <div className="w-full text-center relative h-10 top-24 gap-4 text-[13px] outfit text-[#000000ED] flex   items-center justify-center   ">
          <button className="bg-white hover:bg-[#b3b3b3] px-6 py-2 rounded-full font-semibold text-[15px] cursor-pointer ">About Me</button><button className="border-white bg-transparent border mix-blend-exclusion cursor-pointer px-6 py-2 text-white hover:bg-[#4f4f4f65] hover:bg-[radial-gradient(circle_at_center,#4f4f4f65,transparent_40%)] rounded-full font-semibold text-[15px] ">Get in Touch</button>
        </div>
