          ...
          <div className="flex gap-4 md:justify-center w-[90vw] flex-col md:flex-row min-w-[60vw] md:h-[426.23px]">
            ...
            <div className="w-full md:w-199 h-auto md:h-[26.63rem] rounded-b-3xl rounded-t-none md:rounded-r-3xl md:rounded-l-none border-2 border-[#333333] p-8 md:p-10 flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  <h2 className="text-white text-[2.3rem] md:text-[42px] nyght font-semibold">
                    MediFlow
                  </h2>

                  <p className="text-[#9C9C9C] outfit text-[15px] md:text-[16px] leading-[28px] md:leading-[30px] mt-4 max-w-[95%]">
                    A minimal Hospital Management System focused on core
                    functionality like patient records, appointments, and
                    workflow management using React and LocalStorage.
                  </p>
                </div>

                <div className="flex gap-3 flex-wrap">

                  <span className="px-4 py-2 rounded-full border border-[#333333] text-[#CFCFCF] text-sm outfit">
                    React
                  </span>
...
<a href="https://hms-mediflow.vercel.app/" target="_blank">
                <button className="px-6 py-3 rounded-full bg-white text-black outfit text-sm font-medium hover:scale-105 duration-300">
                  View Project
                </button>
</a>
                {/* Github SVG */}
            ...
            <div className="w-full md:w-199 h-auto md:h-[426.23px] rounded-b-3xl rounded-t-none md:rounded-l-3xl md:rounded-r-none border-2 border-[#333333] p-8 md:p-10 flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <p className="text-[#9C9C9C] outfit text-[15px] md:text-[16px] leading-[28px] md:leading-[30px] mt-4 max-w-[95%]">
                    A minimal Task Management System built using the MERN
                    stack with Framer Motion animations, focused on task
                    organization, workflow handling, and smooth user
                    interactions.
                  </p>
                </div>
              ...
              <div className="flex items-center gap-4 mt-8">
<a href="https://digiflow-chi.vercel.app/" target="_blank">
                <button className="px-6 py-3 rounded-full bg-white text-black outfit text-sm font-medium hover:scale-105 duration-300">
                  View Project
                </button>
</a>
            ...
            <div className="w-full md:w-199 h-auto md:h-[426.23px] rounded-b-3xl rounded-t-none md:rounded-r-3xl md:rounded-l-none border-2 border-[#333333] p-8 md:p-10 flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <p className="text-[#9C9C9C] outfit text-[15px] md:text-[16px] leading-[28px] md:leading-[30px] mt-4 max-w-[95%]">
                    A MERN-based eCommerce platform with email verification,
                    secure authentication, order confirmation emails, and
                    deployment on Vercel using Nodemailer and AlwaysData SMTP.
                  </p>
                </div>
              ...
              <div className="flex items-center gap-4 mt-8">
<a href="https://ecommerce-frontend-mg.vercel.app/" target="_blank">
                <button className="px-6 py-3 rounded-full bg-white text-black outfit text-sm font-medium hover:scale-105 duration-300">
                  View Project
                </button>
</a>
